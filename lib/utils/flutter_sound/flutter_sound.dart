...
class FlutterSound {
  static const MethodChannel _channel =
      const MethodChannel('www.guigug.com/flutter_sound');
  ...
  Future<void> _setPlayerCallback(void Function() playFinishCallback) async {
  ...
  Future<String> startPlayer(
      String uri, void Function() playFinishCallback) async {
    if (this._isPlaying) {
    ...
    try {
      ...
      _setPlayerCallback(playFinishCallback);
